...
Not implemented. The spec is drafted at [`spec/ios.md`](../../spec/ios.md), including the open design questions that need answering before or while you write it.

Start here:

1. Read [`spec/core.md`](../../spec/core.md) and [`spec/ios.md`](../../spec/ios.md).
...
4. Add cases to [`bypasses/ios/`](../../bypasses/) as you go. Your verifier has to catch them all to merge.
