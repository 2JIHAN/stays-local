# windows verifier — wanted

Not implemented. The spec is drafted at [`spec/windows.md`](../../spec/windows.md), including the open design questions that need answering before or while you write it.

Start here:

1. Read [`spec/core.md`](../../spec/core.md) and [`spec/windows.md`](../../spec/windows.md).
...
4. Add cases to [`bypasses/windows/`](../../bypasses/) as you go. Your verifier has to catch them all to merge.
